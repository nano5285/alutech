<?php
$pagination = '
<div style="border-top:1px solid #ccc;"><strong>'. lethe_pages .':</strong></div>
...
if($count > $limit) :
 ...
 $pagination .= '<li><a href="index.php'. $pgVar .'&pgGo='. $pgNext .'">&gt;</a></li><li><a href="index.php'. $pgVar .'&pgGo='. $count .'">»</a></li>';
